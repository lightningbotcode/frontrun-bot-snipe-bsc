/**
 * Initiate attack on pancakeswap high risk-high reward
*/
//const fs = require('fs');
...
async function getCurrentGasPrices() {
    try {
       ...
       var log_str = '***** BnB Gas Price Information Below *****'
       console.log(log_str.green);
...
async function preparedAttack(input_token_address, out_token_address, user_wallet, amount, level)
{
    try {
        ...
        var log_str = '***** Your Current BNB Wallet Balance *****'
        console.log(log_str.green);
